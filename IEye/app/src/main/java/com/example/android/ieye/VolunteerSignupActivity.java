...
public class VolunteerSignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleSignInClient=GoogleSignIn.getClient(VolunteerSignupActivity.this,gso);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i=new Intent(VolunteerSignupActivity.this,StudentdashboardActivity.class);
                            startActivity(i);
                            finish();
                            Toast.makeText(VolunteerSignupActivity.this,"Welcome..",Toast.LENGTH_LONG).show();

                        } else {
                            // If sign in fails, display a message to the user.
                            Toast.makeText(VolunteerSignupActivity.this,"Error..",Toast.LENGTH_LONG).show();
                        }
    ...
    public void btnRegister_click(View v)
    {
        ...
        final ProgressDialog progressDialog = ProgressDialog.show(VolunteerSignupActivity.this,"Please wait...","Processing" ,true);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            rootReference.child("Volunteer").child(firebaseUser.getUid()).setValue(user)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            if(task.isSuccessful())
                                            {
                                                SendMail sm = new SendMail(VolunteerSignupActivity.this, email, subject, message);
                                                sm.execute();

                                                //  Toast.makeText(MainActivity.this,"Welcome " +email,Toast.LENGTH_LONG).show();
                                                Toast.makeText(VolunteerSignupActivity.this,"Welcome "+ email +"\nA mail has been sent with your login " +
                            ...
                            Toast.makeText(VolunteerSignupActivity.this,task.getException().getMessage(),Toast.LENGTH_LONG).show();
    ...
    public void btnLogin_click(View v){
        Intent i=new Intent(VolunteerSignupActivity.this,LoginActivity.class);
        startActivity(i);
    }
