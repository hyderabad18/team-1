...
public class VolunteerLogin extends AppCompatActivity {
    ...
    public void btnLogin_click(View v)
    {
        ...
        final ProgressDialog progressDialog=ProgressDialog.show(VolunteerLogin.this,"Please Wait...","Processing...",true);
        (firebaseAuth.signInWithEmailAndPassword(txtEmailLogin.getText().toString(),txtPasswordLogin.getText().toString()))
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            Toast.makeText(VolunteerLogin.this,"Welcome...",Toast.LENGTH_LONG).show();
                            Intent i=new Intent(VolunteerLogin.this,Stud_profile.class);
                        ...
                        else
                        {
                            ...
                            Toast.makeText(VolunteerLogin.this,task.getException().getMessage(),Toast.LENGTH_LONG).show();
